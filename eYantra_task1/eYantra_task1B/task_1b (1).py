...
# Team ID:			[ 2256 ]
# Author List:		[ Naveen Rajpurohit, Aniket Chanda ]
# Filename:			task_1b.py
...
def detect_ArUco_details(image):
    ...
    for (markerCorner, markerID) in zip(corners, ids):
        ...
        mid_x = (markerCorner[0][0][0] + markerCorner[0][1][0])/2
        mid_y = (markerCorner[0][0][1] + markerCorner[0][1][1])/2
        ...
        if deno > 0 :
            ...
            angle = int(angle)
        # print(angle)
        # print (x_centre, y_centre, markerID)
        for i in markerID:
