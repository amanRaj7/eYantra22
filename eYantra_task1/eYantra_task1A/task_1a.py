...
def detect_arena_parameters(maze_image):
	...
	arena_parameters['medicine_packages_persent'] = detect_medicine_packages(maze_image)
	##################################################
